...
def write_dict_to_csv_file(file_path: str, arr_dict_tofile: list, headerRow: list) -> None:
    """
...
if __name__ == "__main__":
    ...
    write_dict_to_csv_file(input_csv_file, list_dict, header_row)
    ...
    write_dict_to_csv_file(file_name, sorted_arr, header_row)
